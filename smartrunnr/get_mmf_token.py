...
'''Get an authorization token to use with the MapMyFitness API.
'''

# Copied with slight modifications from the MapMyFitness OAuth2 demo
# https://github.com/mapmyfitness/api-examples/blob/master/python/oauth2_authorization_demo.py
...
CLIENT_ID = 'nsnxf9ptznw33fzh59wrdezt2rm3fnkt'
CLIENT_SECRET = 'UPNn8pmWsXNxjPDEBp6uQSnfnRgmdx6xrKFMmnCMDxX'
